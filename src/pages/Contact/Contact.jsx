      ...
      <div className="py-5">
        <div className="row align-items-center py-5">
          <div className="col-lg-8 mb-4">
            <h1 className="fw-semibold medium-title my-heading1">
              <span className="text-dark text-hightlight">
                Let us help you to solve the
              </span>{" "}
              problem.
            </h1>
            <p className="text-muted fs-4 lh-base mt-3">
              <span className="my-text">
                Start from research to working on the real-world projects that
                impactful
              </span>
            </p>
          </div>
                ...
                <form className="p-2" onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <div className="input-group mb-3">
                      <span className="input-group-text border-fade py-3 bg-white">
                        <svg
                      ...
                      <input
                        type="text"
                        className="form-control border-fade py-3"
                        id="name"
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      className="form-control border-fade disable-resize"
                      id="message"
                      rows="5"
                  ...
                  <button
                    type="submit"
                    className="btn btn-dark py-2 text-center w-100"
                  >
                    Send Message
                  </button>
                </form>
